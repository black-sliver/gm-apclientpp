...
ext_apclient_get_missing_locations_json = external_define("gm-apclientpp.dll", "apclient_get_missing_locations_json", dll_cdecl, ty_string, 0);
...
ext_apclient_connect_update = external_define("gm-apclientpp.dll", "apclient_connect_update", dll_cdecl, ty_real, 1, ty_string);
